...
This package implements the self-updating process clustering algorithms proposed in @Shiu2016supc and shows how to reproduce the examples and figures in the paper.
